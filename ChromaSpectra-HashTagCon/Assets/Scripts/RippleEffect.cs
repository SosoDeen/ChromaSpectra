...
public class RippleEffect : MonoBehaviour
{
    ...
    public void TriggerRippleEffect(Color reflectionColor)
    {
        droplets[0].position = new Vector2(0.5f, 0.5f); // Center of the screen
        droplets[0].time = 0;

        reflectionColor.a = reflectionStrength;
        material.SetColor("_Reflection", reflectionColor);
